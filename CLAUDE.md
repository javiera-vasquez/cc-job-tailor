...
- `src/data/resume.ts`: Auto-generated TypeScript data module from merged source files
...
- `data/sources/`: Source data files (resume.yaml, professional-experience.yaml, cover-letter.yaml)
- `data/mapping-rules/`: Transformation rules for resume, job analysis, and cover letter generation
- `data/tailor/`: Company-specific tailored outputs generated by resume-tailor agent
...
### Schema Transformation (`data/mapping-rules/`)
...
**Tailored Output (`data/tailor/[company-name]/`)**:
...
**Transformation Rules (`data/mapping-rules/`)**:
